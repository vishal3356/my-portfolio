...
document.addEventListener("DOMContentLoaded", function() {
    const closeIcon = document.querySelector(".responsive-sidebar-menu .close-settings");
    const sidebarMenu = document.querySelector(".responsive-sidebar-menu");
    const overlay = sidebarMenu.querySelector(".overlay");
